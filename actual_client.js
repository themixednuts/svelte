...
var root_12 = $.from_html(`<option>Boundary</option>`);
var root_13 = $.from_html(`<option><span>Rich in boundary</span></option>`);
...
var option_content_4 = $.from_html(`<!>`, 1);
...
export default function Select_with_rich_content($$anchor) {
...

	{
		var consequent_1 = ($$anchor) => {
			...
			$.each(node, 0, () => items, $.index, ($$anchor, item) => {
				var option_13 = root_11();

				option_13.textContent = item;
	...
	$.customizable_select(select_13, () => {
		...
		var fragment_6 = select_content_1();
		var node_7 = $.first_child(fragment_6);

		Option(node_7, {});
		$.append(anchor_5, fragment_6);
	});
	...
	$.customizable_select(select_14, () => {
		...
		var fragment_7 = select_content_2();
		var node_8 = $.first_child(fragment_7);

		option_snippet(node_8);
		$.append(anchor_6, fragment_7);
	});
	...
	$.customizable_select(select_15, () => {
		...
		var fragment_8 = select_content_3();
		var node_9 = $.first_child(fragment_8);

		$.html(node_9, () => html);
		$.append(anchor_7, fragment_8);
	});
	...
	$.customizable_select(optgroup_2, () => {
		...
		var fragment_9 = optgroup_content();
		var node_10 = $.first_child(fragment_9);

		Option(node_10, {});
		$.append(anchor_8, fragment_9);
	});
	$.reset(select_16);
	...
	$.customizable_select(optgroup_3, () => {
		...
		var fragment_10 = optgroup_content_1();
		var node_11 = $.first_child(fragment_10);

		option_snippet2(node_11);
		$.append(anchor_9, fragment_10);
	});
	$.reset(select_17);
	...
	$.customizable_select(option_16, () => {
		var anchor_10 = $.child(option_16);
		var fragment_11 = option_content_4();
		var node_12 = $.first_child(fragment_11);
		$.html(node_12, () => '<strong>Bold HTML</strong>');
		$.append(anchor_10, fragment_11);
	});
	$.reset(select_18);
	...
	$.customizable_select(select_20, () => {
		...
		var fragment_13 = select_content_5();
